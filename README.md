...
```objc
static NSTimeInterval const RBTTutorialViewControllerNavigationFadeAnimationDuration = 0.3;
```
...
```objc
@interface RBTTutorial : NSObject
...
```objc
static NSString * const RBTAboutViewControllerCompanyName = @"CompanyName.com";
...
All define names should be capital letters
```objc
#define THUMBNAIL_HEIGHT 2
```
